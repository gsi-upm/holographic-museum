...
public class RunWhisper : MonoBehaviour
{
    ...
    private async Awaitable InitializeModels()
    {
        ...
        isInitialized = true;
        Debug.Log("Whisper models initialized");
    }
    
    public async Awaitable<string> TranscribeAudio(AudioClip clip, string language = "en")
    {
        if (clip == null)
        {
        ...
        // Resetear variables para nueva transcripción
        audioClip = clip;
        outputString = "";
        tokenCount = 3;
        transcribe = true;
        ...
        else if (language.ToLower() == "es")
        {
            outputTokens[1] = SPANISH;
        }
        else
        {
            Debug.LogWarning("Language not recognized, defaulting to Spanish");
            outputTokens[1] = SPANISH;
        }

        outputTokens[0] = START_OF_TRANSCRIPT;
        //outputTokens[1] = SPANISH;// GERMAN;//FRENCH;//
        ...
        while (true)
        {
            ...
            {
                Debug.Log("Transcription complete: " + outputString);
                return outputString;
            }
